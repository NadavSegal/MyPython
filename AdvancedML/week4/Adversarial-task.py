...
generator.add(L.Deconvolution2D(64,kernel_size=(5,5),activation='elu'))
generator.add(L.Deconvolution2D(64,kernel_size=(5,5),activation='elu'))
generator.add(L.UpSampling2D(size=(2,2)))
generator.add(L.Deconvolution2D(32,kernel_size=3,activation='elu'))
generator.add(L.Deconvolution2D(32,kernel_size=3,activation='elu'))
generator.add(L.Deconvolution2D(32,kernel_size=3,activation='elu'))
...
for layer in generator.layers:
       print("generator layer %s has: (%s units)"%(layer.name,layer.output_shape))
...
discriminator.add(L.MaxPooling2D())
discriminator.add(L.Conv2D(128,[3,3],activation='elu',padding='same' )) 
discriminator.add(L.MaxPooling2D())  
...
submit_honor((generator, discriminator), 'na.segal@gmail.com', <YOUR_TOKEN>)
