...
########## My additions:
import sys, os 
p1 = '/home/nadav/Documents/MyPython/AdvancedML/'
p2 = '/home/nadav/Documents/MyPython/AdvancedML/week2/'
p3 = '/home/nadav/Documents/MyPython/AdvancedML/week2/v2/'
sys.path.append(p1)
sys.path.append(p2)
sys.path.append(p3)
os.chdir(p2)
...
W = tf.get_variable('W',shape=(X_train_flat.shape[1],10),dtype = tf.float32,trainable = True)  ### YOUR CODE HERE ### tf.get_variable(...) with shape[0] = 784
