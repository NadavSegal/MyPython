...
# 
# ## Answer:
# in test time we will have too large values of the output when the rest of the net work was traind to expect samller values after the dropout layer. 
# 
